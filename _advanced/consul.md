...
6561ec86fc11        turbinelabs/envoy-simple:0.18.2   "/sbin/my_init -- /u…"   Less than a second ago   Up 4 seconds        0.0.0.0:80->80/tcp, 0.0.0.0:9999->9999/tcp, 443/tcp   gracious_shannon
```
...
```console
$ docker run turbinelabs/rotor:0.18.2 rotor consul --help
```
